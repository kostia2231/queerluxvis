...
export default function Cart() {
    ...
    const { isCartOpen, closeCart, addItem, removeItem, getTotalPrice } =
        useCartStore();
                    ...
                    >
                        <div>
                            <div className="flex justify-between border-b">
                                <div className="py-5 max-[600px]:pl-5">
                                    <p>Cart</p>
                                </div>
                                <div className="p-5">
                                    <p
                            ...
                            {totalPrice != 0 && (
                                <div className="pt-5">
                                    <div className="max-[600px]:pl-5">
                                        <span className="font-light">
                                            Subtotal —{" "}
                                        </span>
                                        {`€${totalPrice}`}
                                    </div>
                                    <p className="text-gray-200 pb-5 max-[600px]:pl-5">
                                        Shipping calculated at checkout
                                    </p>

                                    <div
                                        className="max-[600px]:pl-5 py-5 bg-black w-full cursor-pointer hover:bg-[#FF59A8] text-white text-[24px] text-left"
                            ...
                            <div className="pb-5 overflow-y-auto h-[calc(100vh-245px)] ">
                                <div>
                                    {totalPrice != 0 && (
                                        <p className="max-[600px]:pl-5 py-5 text-gray-200 text">
                                            All Items
                                        </p>
                                    )}
                                    {totalPrice === 0 && (
